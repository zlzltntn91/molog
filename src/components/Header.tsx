...
export default function Header({ isDarkMode, toggleTheme }: HeaderProps) {
  ...
  return (
    <header className="flex-none h-14 bg-white/80 dark:bg-[#1c1c1e]/80 backdrop-blur-md flex items-center px-4 z-50 sticky top-0 border-b border-gray-100 dark:border-white/5 justify-between">
